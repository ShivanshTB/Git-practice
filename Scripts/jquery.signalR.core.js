...
(function ($, window, undefined) {
    ...
    var signalR,
        ...
        changeState = function (connection, expectedState, newState) {
					console.log("changeState: ",connection)
					console.log("changeState: ",expectedState)
        ...
        isDisconnecting = function (connection) {
					console.log("isDisconnecting: ",connection0)
            return connection.state === signalR.connectionState.disconnected;
        },

        supportsKeepAlive = function (connection) {
					console.log("supportsKeepAlive: ",connection)
            return connection._.keepAliveData.activated &&
                connection.transport.supportsKeepAlive(connection);
        },

        configureStopReconnectingTimeout = function (connection) {
					console.log("configureStopReconnectingTimeout: ",connection)
...
console.log(logging)
    ...
    signalR._ = {
        ...
        transportError: function (message, transport, source, context) {
					console.log("transportError: ",message)
					console.log("transportError: ",transport)
					console.log("transportError: ",source)
					console.log("transportError: ",context)
        ...
        configurePingInterval: function (connection) {
					console.log("configurePingInterval: ",connection);
    ...
    function validateTransport(requestedTransport, connection) {
        ...
        /// <returns type="Object" />
console.log("validateTransport: ",requestedTransport)
console.log("validateTransport: ",connection)
        if ($.isArray(requestedTransport)) {
            ...
            for (var i = requestedTransport.length - 1; i >= 0; i--) {
                ...
                if ($.type(transport) !== "string" || !signalR.transports[transport]) {
                    ...
                    console.log("Invalid transport: " + transport + ", removing it from the transports list.");
            ...
            if (requestedTransport.length === 0) {
                ...
                console.log("No transports remain within the specified transport array.");
                requestedTransport = null;
            }
        } else if (!signalR.transports[requestedTransport] && requestedTransport !== "auto") {
            connection.log("Invalid transport: " + requestedTransport.toString() + ".");
            console.log("Invalid transport: " + requestedTransport.toString() + ".");
            requestedTransport = null;
    ...
    function getDefaultPort(protocol) {
			console.log("getDefaultPort: ",protocol)
        if (protocol === "http:") {
            return 80;
    ...
    function addDefaultPort(protocol, url) {
        ...
        // following the port in order to avoid removing ports such as 8080.
				console.log("addDefaultPort: ",protocol)
				console.log("addDefaultPort: ",url)
        if (url.match(/:\d+$/)) {
            return url;
        } else {
    ...
    function ConnectingMessageBuffer(connection, drainCallback) {
			console.log("ConnectingMessageBuffer: ",connection)
			console.log("ConnectingMessageBuffer: ",drainCallback)
        var that = this,
            buffer = [];
    ...
    signalR.fn = signalR.prototype = {
        ...
        isCrossDomain: function (url, against) {
            ...
            /// </param>
						console.log("isCrossDomain: ",url)
						console.log("isCrossDomain: ",against)
            var link;
        ...
        start: function (options, callback) {
            ...
            var connection = this,
                ...
                setConnectionUrl = function (connection, url) {
                    ...
                    if (connection.url.indexOf("//") === 0) {
                        ...
                        console.log("Protocol relative URL detected, normalizing it to '" + connection.url + "'.");
                    }

                    if (connection.isCrossDomain(connection.url)) {
                        connection.log("Auto detected cross domain url.");
                        console.log("Auto detected cross domain url.");
                        ...
                        if (!$.support.cors) {
                            ...
                            console.log("Using jsonp because this browser doesn't support CORS.");
                        }
            ...
            initialize = function (transports, index) {
                ...
                if (index >= transports.length) {
                    if (index === 0) {
                        ...
                        console.log("No transports supported by the server were selected.");
                    } else if (index === 1) {
                        connection.log("No fallback transports were selected.");
                        console.log("No fallback transports were selected.");
                    } else {
                        connection.log("Fallback transports exhausted.");
                        console.log("Fallback transports exhausted.");
                    }
                ...
                try {
                    connection._.initHandler.start(transport, function () { // success
                        ...
                        console.log("The start request succeeded. Transitioning to the connected state.");
                        ...
                        if (!changeState(connection,
                            ...
                            console.log("WARNING! The connection was not in the connecting state.");
                        }
                        ...
                        _pageWindow.bind("unload", function () {
                            ...
                            console.log("Window unloading, stopping the connection.");
                    ...
                    console.log(transport.name + " transport threw '" + error.message + "' when attempting to start.");
                    onFallback();
                }
            };
            ...
            var url = connection.url + "/negotiate",
						onFailed = function (error, connection) {
									console.log("negotiate onfailed: ",error);
									console.log("negotiate onfailed: ",connection);
            ...
            console.log("Negotiating with '" + url + "'.");
            ...
            connection._.negotiateRequest = function () {
                var res,
                    ...
                    negotiate = function (connection, onSuccess) {
											console.log("negotiateRequest: ",connection)
											console.log("negotiateRequest: ",onSuccess)
                        ...
                        var options = {
                            ...
                            error: function (error, statusText) {
															console.log("negotiateRequest error: ",error)
															console.log("negotiateRequest error: ",statusText)
                                // We don't want to cause any errors if we're aborting our own negotiate request.
                                if (statusText !== _negotiateAbortText) {
                                    onFailed(error, connection);
																		console.log("negotiateRequest onFailed: ",error)
																		console.log("negotiateRequest onFailed: ",connection)
																		console.log("negotiateRequest onFailed: ",_negotiateAbortText)
                                } else {
                    ...
                    callback = function (result) {
                        ...
                        if (connection.negotiateRedirectSupportedProtocols.indexOf(res.ProtocolVersion) !== -1) {
                            if (res.Error) {
                                ...
                                console.log("Received redirect to: " + res.RedirectUrl);
        ...
        starting: function (callback) {
            ...
            $(connection).bind(events.onStarting, function (e, data) {
                callback.call(connection);
                console.log(callback.call(connection));
            });
            return connection;
        },
        ...
        stateChanged: function (callback) {
            ...
            /// <returns type="signalR" />
						console.log("stateChanged: ",callback);
            var connection = this;
        ...
        error: function (callback) {
            ...
            return connection;
				...
				//explore bind,call and apply methods
        ...
        connectionSlow: function (callback) {
            ...
            /// <returns type="signalR" />
						console.log("connectionSlow: ",callback);
            var connection = this;
        ...
        reconnecting: function (callback) {
            ...
            /// <returns type="signalR" />
						console.log("reconnecting: ",callback);
            var connection = this;
        ...
        reconnected: function (callback) {
            ...
            /// <returns type="signalR" />
						console.log("reconnected: ",callback)
            var connection = this;
